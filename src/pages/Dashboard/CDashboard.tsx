...
import {
  Trophy as TrophyIcon, QrCode, Truck, Camera, Calendar,
  GraduationCap, Gamepad2, Users, BarChart3, Leaf,
} from "lucide-react";
      ...
      <div className="container mx-auto p-3 md:p-5">
        <Tabs defaultValue="overview" className="w-full">
          ...
          <TabsContent value="learning" className="space-y-4 md:space-y-6">
            ...
            {/* ✅ Your Duties as a Citizen — matches Employee dashboard style exactly */}
